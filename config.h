...
/*      pathu                           pathc                           interval        signal */
        ...
        { PATH("dotfiles.sb.sh"),       PATH("dotfiles.button.sb.sh"),  60,             6 },
        { PATH("email.sb.sh"),          PATH("email.button.sb.sh"),     1,              3 },
        { PATH("network.sb.sh"),        PATH("network.button.sb.sh"),   5,              2 },
        { PATH("volume.sb.sh"),         PATH("volume.button.sb.sh"),    0,              5 },
        { PATH("battery.sb.sh"),        NULL,                           5,              0 },
        { PATH("clock.sb.sh"),          PATH("clock.button.sb.sh"),     1,              1 },
